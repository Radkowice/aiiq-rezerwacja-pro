<section class="panel-card hidden" data-section="email">
  ...
  <div class="settings-card email-settings-card email-fallback-notice">
    ...
    <p class="settings-desc">
      Jeśli nie skonfigurujesz własnego połączenia e-mail oraz nie ustawisz szablonów wiadomości, system wyśle podstawowe powiadomienia z adresu systemowego Rezerwia.
    </p>
    <p class="settings-desc">
